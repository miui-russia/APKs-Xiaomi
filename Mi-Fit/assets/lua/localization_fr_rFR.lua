localization_fr_rFR_table = {
    ...
    unlock_hint_info="Dites adieu à votre mot de passe",
    unlock_password_hint="Définissez le verrouillage d\'écran pour sécuriser le téléphone.",
    unlock_password_hint_info="Le Mi-Fit fournit le meilleur déverrouillage d\'écran.",
    no_data_hint_0="Restez en mouvement pour votre bien-être",
    no_data_hint_1="Pour garder le sourire, il suffit de courir",
    no_data_hint_2="Une séance de cardio chaque jour vous maintiendra en pleine forme",
    no_data_hint_3="Peu importe que vous soyez lent, vous êtes mieux ici que sur votre canapé.",
    not_binded_hint="Aucun Mi-Fit ajouté à ce compte.",
    not_binded_hint_info="Vous pouvez aussi accéder à la Balance depuis le menu.",
    ...
    manual_lazy_subtitle_used="Vous pouvez avoir plus de jours de repos en battant vos records personnels.",
    manual_fail_ytd_title = "Vous avez fini votre série aujourd'hui.",
    manual_fail_ytd_subtitle = "Votre série a été de %d.",

    active_time_format_0="%d h",
    ...
    get_distance_format=", distance totale de %d m.",
