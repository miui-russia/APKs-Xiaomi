localization_fr_rFR_table = {
    calories_table={
        {str="≈1 œuf dur",	calories=96},
        {str="≈1 tranche de pain",	calories=100},
        {str="≈1 bouteille de thé glacé",	calories=112},
        {str="≈1 omelette",	calories=118},
        {str="≈2 filets Kebab",	calories=124},
        {str="≈1 canette de CocaCola",	calories=153},
        {str="≈3 filets Kebab",	calories=186},
        {str="≈2 oeufs durs",	calories=192},
        {str="≈2 tranches de pain",	calories=200},
        {str="≈1 bol de riz",	calories=210},
        {str="≈1 pain",	calories=221},
        {str="≈1 cenelle (baies) dragéifié",	calories=223},
        {str="≈2 bouteilles de thé glacé",	calories=224},
        {str="≈1 petit cornet de frites",	calories=224},
        {str="≈1 tarte",	calories=224},
        {str="≈2 œufs frits",	calories=236},
        {str="≈4 filets Kebab",	calories=248},
        {str="≈1 hamburger",	calories=260},
        {str="≈1 beignet",	calories=270},
        {str="≈1 boulette de viande",	calories=272},
        {str="≈3 œufs durs",	calories=288},
        {str="≈1 cône",	calories=290},
        {str="≈3 pains",	calories=300},
        {str="≈2 canettes de Coca-Cola",	calories=306},
        {str="≈1 cornet de frites",	calories=328},
        {str="≈3 omelettes",	calories=354},
        {str="≈1 oeuf au plat",	calories=375},
        {str="≈4 pains",	calories=400},
        {str="≈1 gros cornet de frites",	calories=402},
        {str="≈2 bols de riz",	calories=420},
        {str="≈2 pains",	calories=442},
        {str="≈2 cenelles (baies) dragéifiés",	calories=446},
        {str="≈1 tarte",	calories=448},
        {str="≈1 paquet de nouilles instantanées",	calories=470},
        {str="≈5 pains",	calories=500},
        {str="≈1 riz sauté",	calories=516},
        {str="≈2 hambourger",	calories=520},
        {str="≈2 beignets",	calories=540},
        {str="≈2 brioches vapeur",	calories=544},
        {str="≈2 cônes",	calories=580},
        {str="≈1 bol de nouilles instantanées",	calories=581},
        {str="≈1 bol de nouilles au boeuf",	calories=593},
        {str="≈10 filets Kebab",	calories=620},
        {str="≈3 bols de riz",	calories=630},
        {str="≈3 pains",	calories=663},
        {str="≈2 oeufs au plat",	calories=750},
        {str="≈3 beignets",	calories=810},
        {str="≈3 brioches vapeur",	calories=816},
    },
